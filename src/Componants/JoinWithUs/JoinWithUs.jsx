...
import bg from "../../assets/images/joinBackground.jpg"
...
const JoinWithUs = () => {
    ...
    // You can call this function to test your credentials
    // useEffect(() => {
    //     testEmailJSCredentials();
    // }, []);

    // Rest of your component JSX remains exactly the same...
    return (
        <div id="apply" className="relative min-h-screen w-full overflow-hidden">
            {/* Background Image */}
            <div
            ...
            <div className="relative z-10 min-h-screen flex items-center">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
                    <div className="max-w-6xl">
                        {/* Glass Morphism Content Box - Animated from left */}
                        <div
                            className={`backdrop-blur-sm bg-gray-900/60 border border-white/10 rounded-3xl p-6 sm:p-8 lg:py-12 md:pl-[6rem] shadow-2xl transform transition-all duration-1000 ease-out xl:ml-[6rem] justify-center items ${
                                isVisible ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'
                            }`}
                        >
                            <div className={"flex"}>
                                <div className="w-9 h-0.5 bg-gradient-to-r from-orange-500 to-red-600 mt-3 mr-3" />
                                <h3 className="text-[#F44A1E] font-semibold text-sm sm:text-base lg:text-md uppercase tracking-wider mb-4 lg:mb-6">
                                    Interested in Joining With Us?
                                </h3>
                            </div>

                            <h1 className="text-white font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-5xl leading-tight mb-6 lg:mb-8 max-w-4xl">
                                Join Us For Information About New Student Admission
                            </h1>

                            <p className="text-gray-200 text-sm sm:text-base lg:text-lg leading-relaxed mb-8 lg:mb-12 max-w-3xl">
                                At the Colombo Institute of Sales & Distribution (CISD), we redefine professional education with a bold fusion of innovation, industry insight, and strategic leadership. As Sri Lanka’s pioneering institution dedicated exclusively to Sales, Marketing, and Distribution Management, we go beyond traditional learning to deliver transformative, career-defining experiences.
                            </p>

                            <button
                                onClick={() => setIsModalOpen(true)}
                                className="group relative bg-gradient-to-r from-orange-400 via-orange-500 to-red-600 text-white px-10 py-3 rounded-full font-medium text-xl flex items-center gap-3 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-slide-in-bottom"
                            >
                                <span className="absolute inset-0 bg-gradient-to-r from-red-600 via-orange-500 rounded-full to-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
